...
class ExerciseFunction{
  static void addingFieldstoControllers(Exercise exercise){
    ...
    exerciceAddPageTextEditingControllers[3].text=exercise.burnCalorie.toString();
    exerciceAddPageTextEditingControllers[4].text=exercise.focusedArea;  
    exerciceAddPageTextEditingControllers[5].text=exercise.count!=null?exercise.count.toString():exercise.duration;
    exerciceAddBloc.add(ExerciseEditEvent(image: exercise.demo, groupValue: exercise.count!=null?'Count':'Time'));
  }
}